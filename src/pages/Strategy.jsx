...
export const Strategy = () => {
    ...
    return (
        <main className="pt-48 pb-24 px-6 md:px-12 w-full max-w-screen-2xl mx-auto min-h-screen">
            <Helmet>
                <title>Agentic Strategy | Ai Velocity Foundry</title>
                <meta name="description" content="Agentic Strategy operates via autonomous loops, running millions of competitive simulations per second to identify unavoidable checkmate scenarios." />
