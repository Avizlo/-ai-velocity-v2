            ...
            <div className="max-w-screen-2xl mx-auto px-6 md:px-12 relative z-10">
                ...
                <div ref={gridRef} className="grid grid-cols-1 md:grid-cols-3 gap-4" style={{ gridTemplateRows: 'auto auto' }}>
                    ...
                    <div className="bento-anim relative md:row-span-2 rounded-2xl bg-charcoal p-8 flex flex-col min-h-[560px] ring-1 ring-charcoal/5 overflow-hidden transition-all duration-300 hover:-translate-y-1 opacity-0">
                        ...
                        <Link href="/news-insights?category=agentic-payments" className="relative z-10 mt-auto self-start inline font-sans text-white/60 text-xs tracking-widest uppercase border-b border-white/10 pb-1 hover:text-electric-mint hover:border-electric-mint/50 transition-colors duration-200">
...
export default function AgenticPayments() {
    ...
    const schema = {
        ...
        "@graph": [
            ...
            {
                "@type": "WebPage",
                "@id": "https://example.com/agentic-payments/#webpage",
                ...
                "about": { "@id": "https://example.com/agentic-payments/#service" },
                "speakable": {
            ...
            },
            {
                ...
                "itemListElement": [
                    ...
                    },
                    {
                        ...
                        "item": "https://example.com/agentic-payments"
                    }
                ]
            },
            {
                "@type": "Service",
                "@id": "https://example.com/agentic-payments/#service",
                "name": "Agentic Payments",
